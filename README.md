...
- Operate: [http://camunda.local:8081](http://camunda.local:8081)
- Tasklist: [http://camunda.local:8082](http://camunda.local:8082)
- Optimize: [http://camunda.local:8083](http://camunda.local:8083)
- Identity: [http://camunda.local:8084](http://camunda.local:8084)
- Elasticsearch: [http://camunda.local:9200](http://camunda.local:9200)
- Web Modeler: [http://camunda.local:8070](http://camunda.local:8070)

Keycloak is used to manage users. Here you can log in with the user `admin` and password `admin`
- Keycloak: [http://camunda.local:18080/auth/](http://camunda.local:18080/auth/)
...
- Kibana: [http://camunda.local:5601](http://camunda.local:5601)
...
* OAuth URL: `http://camunda.local:18080/auth/realms/camunda-platform/protocol/openid-connect/token`
* Audience: `zeebe-api`
...
### Login
You can access Web Modeler and log in with the user `demo` and password `demo` at [http://camunda.local:8070](http://camunda.local:8070).
...
You can access emails in Mailpit's Web UI at [http://camunda.local:8075](http://camunda.local:8075).
